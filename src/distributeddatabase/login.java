...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 6, true));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            String password = new String(psd);
            if(uname.equals("RASHED") && (password.equals("66586")))
            {
               //JOptionPane.showConfirmDialog(null, "valid user");
               //NewJFrame donor = new NewJFrame();
